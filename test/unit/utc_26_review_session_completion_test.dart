...
void main() {
  ...
  test('UTC-26-TC01: Trigger isComplete when all cards in session are rated', () async {
  ...
  test('UTC-26-TC02: Accurately compile session summary metrics', () async {
    await initSession([createCard('1'), createCard('2'), createCard('3')]);
  ...
  test('UTC-26-TC03: Update daily learning streak on first review activity', () async {
  ...
  test('UTC-26-TC04: Preserve previously rated cards on midway session exit', () async {
    await initSession([createCard('1'), createCard('2'), createCard('3')]);
