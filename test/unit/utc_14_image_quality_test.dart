...
/// UTC-14: Validate Image Quality (Blur Detection)
...
void main() {
  printTestHeader('UTC-14: Validate Image Quality (Blur Detection)');

  // Get the test data directory
  final testDataDir = Directory('test/test_data/images');

  group('UTC-14: Validate Image Quality (Blur Detection)', () {
    group('Image Quality Validation', () {
      test('UT-14-TC01: Clear high-resolution image passes quality check', () async {
      ...
      test('UT-14-TC02: Blurry image fails quality check', () async {
      ...
      test('UT-14-TC03: Low-resolution image fails quality check', () async {
