...
/// UTC-12: Check Camera and Gallery Permission
...
void main() {
  printTestHeader('UTC-12: Check Camera and Gallery Permission');

  group('UTC-12: Check Camera and Gallery Permission', () {
    group('Camera Permission', () {
      test('UT-12-TC01: Camera permission already granted', () {
      ...
      test('UT-12-TC02: Camera permission denied', () {
        // Expected output according to test plan:
        final expected = {
    ...
    group('Gallery Permission', () {
      test('UT-12-TC03: Gallery permission already granted', () {
        // Expected output according to test plan:
        final expected = {
          'permissionGranted': true,
          'action': 'open_gallery',
      ...
      test('UT-12-TC04: Gallery permission denied', () {
        // Expected output according to test plan:
        final expected = {
          'permissionGranted': false,
          'dialog': {
