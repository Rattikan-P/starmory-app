...
void main() {
  printTestHeader('UTC-11: Validate Image Format');

  // Get the test data directory
  final testDataDir = Directory('test/test_data/images');

  group('UTC-11: Validate Image Format', () {
    group('Valid formats', () {
      test('UT-11-TC01: Accept valid JPEG image (.jpg)', () {
        // Arrange
      ...
      test('UT-11-TC02: Accept valid JPEG image (.jpeg)', () {
        // Arrange
      ...
      test('UT-11-TC03: Accept valid PNG image', () {
        // Arrange
    ...
    group('Unsupported formats', () {
      test('UT-11-TC04: Reject unsupported GIF format', () {
        // Arrange
      ...
      test('UT-11-TC05: Reject unsupported WebP format', () {
        // Arrange
