...
/// UTC-13: Check User Quota Before Generation
...
void main() {
  printTestHeader('UTC-13: Check User Quota Before Generation');

  group('UTC-13: Check User Quota Before Generation', () {
    group('Guest User Quota', () {
      test('UT-13-TC01: Guest user has remaining quota', () {
      ...
      test('UT-13-TC02: Guest user quota exhausted', () {
    ...
    group('Registered User Quota', () {
      test('UT-13-TC03: Registered user has remaining daily quota', () {
      ...
      test('UT-13-TC04: Registered user daily quota exhausted', () {
