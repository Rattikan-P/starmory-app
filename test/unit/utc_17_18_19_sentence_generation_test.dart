...
void main() {
  ...
  printTestHeader('UTC-17-18-19: Sentence Generation');
  ...
  group('UTC-17: Generate Default Sentences with Indicative Tone', () {
    group('Expected Output Structures', () {
      test('UT-17-TC01: B1 US English sentence generation', () async {
      ...
      test('UT-17-TC02: A1 UK English sentence generation', () async {
        // Arrange: Create expected result
        // Using real vocabulary from valid1.jpg (picnic hamper scene)
        final expectedResult = SentenceGenerationResult.normal(
          level: 'A1',
      ...
      test('UT-17-TC03: TimeoutException handling', () async {
  ...
  group('UTC-18: Regenerate Sentence with Custom Context', () {
    group('Expected Output Structures', () {
      test('UT-18-TC01: Imperative tone Daily Life context', () async {
        // Arrange: Create expected result
        // Using real vocabulary from valid1.jpg (picnic hamper scene)
        final expectedResult = SentenceGenerationResult.normal(
          level: 'B1',
      ...
      test('UT-18-TC02: Conditional tone Nature context', () async {
        // Arrange: Create expected result
        // Using real vocabulary from valid1.jpg (picnic hamper scene)
        final expectedResult = SentenceGenerationResult.normal(
          level: 'B1',
      ...
      test('UT-18-TC03: Custom category picnic context', () async {
  ...
  group('UTC-19: Generate Combined Sentence for Selected Words', () {
    group('Expected Output Structures', () {
      test('UT-19-TC01: Combined sentence for 3 words', () async {
      ...
      test('UT-19-TC02: Combined sentence with Conditional tone and UK variant', () async {
        // Arrange: Create expected combined result
        // Using real vocabulary from valid1.jpg (picnic hamper scene)
        final expectedResult = SentenceGenerationResult.combined(
          level: 'B1',
