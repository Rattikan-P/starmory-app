...
import 'utc_15_vocabulary_extraction_test.mocks.dart';

/// UTC-15: Deduct Quota and Call Gemini AI for Vocabulary Extraction
...
void main() {
  ...
  printTestHeader('UTC-15: Vocabulary Extraction from Image');
  ...
  group('UTC-15: Vocabulary Extraction from Image', () {
    group('Expected Output Structures', () {
      test('UT-15-TC01: Successful extraction returns expected structure', () async {
      ...
      test('UT-15-TC02: TimeoutException is thrown correctly', () async {
      ...
      test('UT-15-TC03: Network Exception is thrown correctly', () async {
